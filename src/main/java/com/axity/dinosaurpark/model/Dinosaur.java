...
public abstract class Dinosaur {
    ...
    public void escape() { status = DinosaurStatus.ESCAPED; }
    public void recapture() { status = DinosaurStatus.RECAPTURED; }
    public void returnToEnclosure() { status = DinosaurStatus.IN_ENCLOSURE; }

    @Override
    public String toString() {
        return "Dinosaur{id=" + id + ", name='" + name + "', species='" + species + "', status=" + status + "}";
    }
}